			...
			<div class="chooseWindows_input">
				...
				<div class="selectButtonNumber">
					<svg version="1.1" id="right"	viewBox="0 0 40 40">
						...
						<polygon class="st1" points="27.4,14 18.2,23.2 12.6,17.5 11.2,18.9 16.8,24.6 18.2,26 28.8,15.4 "/>
					</svg>
					<svg version="1.1" id="wrong" viewBox="0 0 40 40">
						...
						<polygon class="st1" points="27.8,13.6 26.4,12.2 20,18.6 13.6,12.2 12.2,13.6 18.6,20 12.2,26.4 13.6,27.8 20,21.4 26.4,27.8 
							27.8,26.4 21.4,20 "/>
					</svg>
				</div>
			</div>
				<div class="chooseStyleNumber">
					...
					<div class="allScrew">
						<svg version="1.1" id="pixel"	viewBox="0 0 40 40">
							...
							<g>
								<path class="st0" d="M2.9,40v-5.7h11.4V11.4H8.6V5.7h5.7V0h11.4v34.3h11.4V40H2.9z"/>
							</g>
						</svg>
